...
<?php if(!function_exists('dynamic_sidebar') || !dynamic_sidebar('support-float')) ?>
            ...
            <div class="warp-320">
            	<iframe src="https://www.facebook.com/plugins/likebox.php?href=https%3A%2F%2Fwww.facebook.com%2FMyBossGearGaming&amp;width=320&amp;height=210&amp;colorscheme=dark&amp;show_faces=true&amp;header=true&amp;stream=false&amp;show_border=false" scrolling="no" frameborder="1" style="border:#363636 solid 1px; overflow:hidden; width:318px; height:208px; margin-bottom:20px;" allowTransparency="true"></iframe>
						...
						<div class="footer-panel footer-panel-1">
							<?php if(!function_exists('dynamic_sidebar') || !dynamic_sidebar('footer-panel-1')) ?>
						</div>
						
						<div class="footer-panel footer-panel-2">
							<?php if(!function_exists('dynamic_sidebar') || !dynamic_sidebar('footer-panel-2')) ?>
						</div>
							
						<div class="footer-panel footer-panel-3">
							<?php if(!function_exists('dynamic_sidebar') || !dynamic_sidebar('footer-panel-3')) ?>
						</div>
						
						<div class="footer-panel footer-panel-4">
							<?php if(!function_exists('dynamic_sidebar') || !dynamic_sidebar('footer-panel-4')) ?>
						</div>
        </div>
        <br style="clear: both" />
    </div>
